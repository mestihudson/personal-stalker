...
describe('@/services/Timer', () => {
  ...
  const mockNow = (value) => {
    jest.resetAllMocks()
    Now.get = jest.fn().mockReturnValue(value)
  }
  ...
  it.each([
      ...
      ['2020-03-28 16:59:00', NOW, 1, '2020-03-28 16:59:00', undefined, '0:00:01:01'],
      ['2020-03-27 17:00:00', NOW, 1, '2020-03-27 17:00:00', undefined, '1:00:00:01'],
      ['2019-03-28 17:00:00', NOW, 1, '2019-03-28 17:00:00', undefined, '366:00:00:01'],
      ['2019-03-28 17:00:00', NOW, 36, '2019-03-28 17:00:00', 36, '366:00:00:36'],
      ['2020-04-03 17:00:00', '2020-04-03 18:00:00', 0, '2020-04-03 17:00:00', 0, '0:01:00:00']
    ])('deve incrementar o intervalo entre %p e %p em %p segundo(s)', async (
      timeDesc, reference, incrementDesc, time, increment, assert
    ) => {
    mockNow(reference)
    expect(Timer.elapsed(time, increment)).toBe(assert)
  })
